...
description: "Hubnutí po 50 letech: jak nastavit jídelníček, silový trénink a kalorický deficit s ohledem na menopauzu, sarkopenii a hormonální změny. Plán na 12 týdnů."
permalink: /hubnuti-po-50/
date: 2026-03-25
dateModified: 2026-05-10
category: "Hubnutí"
perex: "Padesátka není konec, je to nový začátek. Hubnutí po 50 má svá specifika: pomalejší metabolismus, hormonální změny, sarkopenie. Tady je plán, který tohle bere v potaz a funguje dlouhodobě."
heroImage: "/img/hubnuti-po-50.webp"
heroAlt: "Hubnutí po 50: jak na to bezpečně a účinně"
ogImage: "/img/og-hubnuti-po-50.png"
sources:
  - { label: "NIH NIA – Menopause: What it is and what to expect", url: "https://www.nia.nih.gov/health/menopause/what-menopause" }
  ...
  - { label: "NHLBI – Heart-healthy living", url: "https://www.nhlbi.nih.gov/health/heart-healthy-living" }
  - { label: "Davis SR et al. – Menopause hormone therapy and weight (BMJ 2022)", url: "https://pubmed.ncbi.nlm.nih.gov/36631145/" }
  - { label: "WHO – Physical activity guidelines (adults 65+)", url: "https://www.who.int/news-room/fact-sheets/detail/physical-activity" }
  - { label: "ÚZIS – Zdravotnická ročenka ČR", url: "https://www.uzis.cz/" }
jsonld:
  - "@context": "https://schema.org"
    "@type": "Article"
    headline: "Hubnutí po 50: jak na to bezpečně a účinně"
    description: "Hubnutí po 50 letech: jak nastavit jídelníček, silový trénink a kalorický deficit s ohledem na menopauzu, sarkopenii a hormonální změny."
  ...
  - "@context": "https://schema.org"
    ...
    mainEntity:
      - "@type": "Question"
        name: "Jde zhubnout v menopauze?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Ano. Menopauza hubnutí komplikuje, ale neznemožňuje. Klíčem je menší kalorický deficit (200–400 kcal), víc bílkovin (1,2–1,5 g/kg) a silový trénink 2–3× týdně, který kompenzuje pokles estrogenu a sarkopenii. Realistické tempo po 50 je 0,3–0,5 kg za týden."
      - "@type": "Question"
        name: "Pomáhá hormonální substituční terapie s hubnutím?"
        acceptedAnswer:
          "@type": "Answer"
          text: "HRT přímo nezpůsobuje hubnutí, ale zmírňuje příznaky menopauzy (návaly, špatný spánek, depresivní nálady), což nepřímo pomáhá udržet zdravý životní styl. Studie publikovaná v BMJ 2022 ukazuje, že u žen na HRT je menší přerozdělení tuku do oblasti břicha. O nasazení HRT rozhoduje gynekolog."
      - "@type": "Question"
        name: "Kolik bílkovin denně potřebuju po 50?"
        acceptedAnswer:
          "@type": "Answer"
          text: "1,2–1,5 g na kg tělesné hmotnosti, rozložené rovnoměrně do 3–4 jídel po 25–35 g bílkovin. Pro 70kg ženu jde o 85–105 g bílkovin denně. Vyšší příjem chrání svaly při kalorickém deficitu a zmírňuje sarkopenii."
      - "@type": "Question"
        name: "Je silový trénink po 50 bezpečný?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Ano, je dokonce nutný. ACSM doporučuje silový trénink 2–3× týdně pro všechny dospělé nad 50, včetně lidí s artrózou, vysokým tlakem nebo diabetem. Začněte s vlastní vahou nebo lehkými činkami pod dohledem trenéra. Po prvním měsíci vidíte zlepšení síly a rovnováhy."
      - "@type": "Question"
        name: "Co dělat, když mám osteoartrózu kolen a nemůžu cvičit?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Osteoartróza není kontraindikace cvičení, ale úprava výběru aktivit. Plavání, jízda na rotopedu, eliptický trenažer a silový trénink na strojích zatěžují klouby minimálně. Hubnutí je pro klouby ochranné: každé kilo úbytku znamená 4 kg méně tlaku na koleno při chůzi."
---
...
Sarkopenie je úbytek svalové hmoty, který přichází s věkem. Po 50. roce **ztrácíte 1–2 % svalů ročně** ([Cruz-Jentoft et al., 2019](https://pubmed.ncbi.nlm.nih.gov/30312372/)), pokud aktivně neposilujete. Méně svalů znamená nižší [bazální metabolismus](/bazalni-metabolismus/) – tělo spálí méně kalorií i v klidu.

To má pro hubnutí dvě praktické konsekvence: cílem **není jen ztratit tuk, ale aktivně chránit svaly**. A podle [Pontzera et al. (Science 2021)](https://pubmed.ncbi.nlm.nih.gov/34385400/) je BMR po 60. roce konečně skutečně klesá, ale mezi 20.–60. rokem zůstává až překvapivě stabilní. Hlavní vinu na „pomalejším metabolismu" po 50 nese tedy ztráta svalů, ne věk sám.
...
Pokud chcete zjistit, do jaké hmotnostní kategorie spadáte, [spočítejte si BMI](/) a podívejte se na [stupně obezity](/stupne-obezity/).
...
Pro orientační výpočet TDEE použijte naši [BMR / TDEE kalkulačku](/kalkulacka-bmr/) – zadáte věk, výšku, váhu a aktivitu. Pro plánování délky hubnutí je užitečná i [kalkulačka kalorického deficitu](/kalkulacka-deficit/).
...
Posilování je po 50 **důležitější než kardio**. Buduje svaly (kompenzuje sarkopenii), zpevňuje kosti (prevence osteoporózy) a zlepšuje rovnováhu (prevence pádů, které jsou po 65 hlavní příčinou hospitalizace seniorů). [ACSM](https://www.acsm.org/docs/default-source/files-for-resource-library/exercise-and-physical-activity-for-older-adults.pdf) doporučuje silový trénink **2–3× týdně** pro všechny dospělé nad 50.
...
- **Chůze** – 30–45 minut denně, ideálně svižným tempem (5–6 km/h). Více v článku [hubnutí chůzí](/hubnuti-chuzi/).
...
WHO doporučuje **150 minut středně intenzivního kardia týdně**. Pro hubnutí je optimální zóna 2 (60–70 % maximálního tepu). Spočítejte si zóny v [kalkulačce tepových zón](/kalkulacka-tep/).
...
HRT (estrogen, případně s progestinem) nezpůsobuje hubnutí přímo, ale **zmírňuje příznaky menopauzy** (návaly horka, špatný spánek, depresivní nálady), což nepřímo pomáhá udržet zdravý životní styl. [Davis SR et al. (BMJ 2022)](https://pubmed.ncbi.nlm.nih.gov/36631145/) ukázali, že u žen na HRT je menší přerozdělení tuku do oblasti břicha.
...
- **Týden 1:** návštěva praktického lékaře, krevní obraz, hormony štítné žlázy, glykémie, lipidy. Spočítejte si TDEE v [BMR kalkulačce](/kalkulacka-bmr/).
...
Pokud chcete vidět, jak se to liší od mladší dekády, podívejte se na [hubnutí po 40](/hubnuti-po-40/).
