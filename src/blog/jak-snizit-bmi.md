...
title: "Jak snížit BMI: kompletní průvodce"
description: "Kompletní průvodce, jak snížit BMI zdravě. Kalorický deficit, strava, silový trénink, plán na 12 týdnů a 7 nejčastějších chyb. Podle WHO a NIH."
permalink: /jak-snizit-bmi/
date: 2024-09-15
dateModified: 2026-05-05
category: "BMI"
perex: "Pokud vám kalkulačka ukázala BMI nad 25, čeká vás cesta. Tady je rozumný plán – bez extrémů, který funguje dlouhodobě a stojí na doporučeních WHO, NIH a NICE."
heroImage: "/img/jak-snizit-bmi.webp"
heroAlt: "Cesta k nižšímu BMI – zdravý životní styl"
ogImage: "/img/og-jak-snizit-bmi.png"
sources:
  - { label: "WHO – Obesity and overweight", url: "https://www.who.int/news-room/fact-sheets/detail/obesity-and-overweight" }
  - { label: "NIH NHLBI – Aim for a Healthy Weight", url: "https://www.nhlbi.nih.gov/health/educational/lose_wt/" }
  - { label: "CDC – Healthy Weight, Nutrition, and Physical Activity", url: "https://www.cdc.gov/healthyweight/" }
  ...
  - { label: "Nedeltcheva AV et al. – Insufficient sleep undermines dietary efforts (Ann Intern Med 2010)", url: "https://pubmed.ncbi.nlm.nih.gov/20921542/" }
  - { label: "ÚZIS – Zdravotnická ročenka ČR", url: "https://www.uzis.cz/" }
jsonld:
  - "@context": "https://schema.org"
    "@type": "Article"
    headline: "Jak snížit BMI: kompletní průvodce"
    description: "Kompletní průvodce, jak snížit BMI zdravě. Kalorický deficit, strava, silový trénink, plán na 12 týdnů a 7 nejčastějších chyb."
    ...
    image: "https://idealnibmi.com/img/og-jak-snizit-bmi.png"
    mainEntityOfPage: "https://idealnibmi.com/jak-snizit-bmi/"
  - "@context": "https://schema.org"
    "@type": "FAQPage"
    mainEntity:
      - "@type": "Question"
        name: "Kolik kilogramů za týden je realistické zhubnout?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Bezpečné a udržitelné tempo je 0,5–1 kg za týden, což odpovídá kalorickému deficitu 300–500 kcal denně. Doporučují to NIH i NICE. Vyšší úbytek typicky znamená ztrátu vody a svalů, ne tuku."
      - "@type": "Question"
        name: "Pomáhá přerušovaný půst při snižování BMI?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Přerušovaný půst (např. 16:8) může pomoci, pokud vám usnadní udržet kalorický deficit. Studie ukazují srovnatelné výsledky s klasickou kalorickou restrikcí, pokud je celkový denní příjem stejný. Sám o sobě tedy nezhubnete – funguje jako forma stravovacího okna."
      - "@type": "Question"
        name: "Jak zhubnout břišní tuk?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Cíleně zhubnout břicho nelze – tělo redukuje tuk plošně, podle genetiky. Co funguje: kalorický deficit, silový trénink (zachová svaly), zóna 2 kardio, dostatek spánku a snížení stresu. Viscerální tuk (uvnitř břišní dutiny) reaguje na snížení BMI obvykle dříve než podkožní."
      - "@type": "Question"
        name: "Co dělat při stagnaci na váze?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Stagnace 2–3 týdny je normální (zadržování vody, hormonální cyklus). Pokud trvá 4+ týdny: přepočítejte TDEE podle nové hmotnosti, zkontrolujte přesnost kalorického záznamu (často podhodnocujeme o 200–500 kcal), ověřte, že máte dostatek bílkovin a spánku. Nezvyšujte deficit – spíš zařaďte refeed den."
      - "@type": "Question"
        name: "Stačí jen chodit, nebo musím cvičit ve fitku?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Pro snížení BMI stačí chůze + úprava stravy. Ale silový trénink výrazně zlepšuje výsledek: chrání svaly při deficitu, drží metabolismus a tělo po hubnutí vypadá jinak. Optimální kombinace pro většinu lidí: 7 000–10 000 kroků denně + 2 silové tréninky týdně."
---
...
Nadváha a obezita patří mezi nejvýznamnější rizikové faktory chronických onemocnění. Podle [WHO](https://www.who.int/news-room/fact-sheets/detail/obesity-and-overweight) se počet lidí s obezitou od roku 1975 ztrojnásobil a v roce 2022 trpělo nadváhou nebo obezitou přes 2,5 miliardy dospělých. V Česku má nadváhu nebo obezitu přibližně **60 % dospělé populace** (data ÚZIS), což nás řadí mezi nejtěžší národy Evropy.

Vysoké BMI samo o sobě není diagnóza, ale je to **silný prediktor** zdravotních rizik. Ne každý s BMI 27 je nemocný a ne každý s BMI 24 je zdravý. Číslo dává základní rámec, který by měl posoudit lékař v kontextu obvodu pasu, krevních hodnot a životního stylu. Pro přesnější obraz si můžete spočítat [poměr pasu k výšce (WHtR)](/kalkulacka-whtr/), který lépe vystihuje viscerální tuk.
...
Pokud vás zajímá, do jaké přesně klasifikace s vaším číslem spadáte, podívejte se na [stupně obezity podle BMI](/stupne-obezity/).

## Základní rovnice: kalorický deficit

Hubnutí stojí na jednom principu: **přijmete méně energie, než kolik vydáte**. Tomu se říká kalorický deficit. Tělo pak čerpá energii z tukových zásob a hmotnost klesá. Hall KD et al. ([Lancet 2011](https://pubmed.ncbi.nlm.nih.gov/21872751/)) ukázali, že úbytek 1 kg tělesné hmoty zhruba odpovídá deficitu 7 000–7 700 kcal kumulativně.

Pro výpočet, kolik kalorií spalujete, se používá **TDEE (Total Daily Energy Expenditure)**:

> **TDEE = BMR × koeficient aktivity.** BMR (bazální metabolismus) tvoří 60–70 % celkového výdeje. Spočítáte si ho v naší [BMR / TDEE kalkulačce](/kalkulacka-bmr/) podle vzorce Mifflin-St Jeor.

### Jaký deficit je bezpečný

Bezpečný deficit pro dlouhodobé hubnutí je **300–500 kcal denně**, což odpovídá úbytku zhruba **0,5 kg za týden**. Toto tempo doporučuje [NIH NHLBI](https://www.nhlbi.nih.gov/health/educational/lose_wt/) i [NICE NG246](https://www.nice.org.uk/guidance/ng246) jako bezpečné a udržitelné. Větší deficity vedou k:
...
Pokud chcete vědět, jak dlouho vám hubnutí potrvá, použijte [kalkulačku kalorického deficitu](/kalkulacka-deficit/) – zadáte aktuální a cílovou hmotnost a vyjde vám realistický odhad v týdnech.
...
Více o praktickém [počítání kalorií](/pocitani-kalorii/) a typických chybách najdete v samostatném článku.
...
[WHO doporučuje](https://www.who.int/news-room/fact-sheets/detail/physical-activity) **150 minut středně intenzivního kardia týdně** (chůze, kolo, plavání) nebo 75 minut vysoce intenzivního (běh, HIIT). Pro hubnutí je optimální **zóna 2** (60–70 % maximálního tepu) – v ní tělo čerpá energii převážně z tuků a regenerace je rychlá.

Spočítejte si přesnou cílovou tepovou frekvenci v [kalkulačce tepových zón](/kalkulacka-tep/). Více o tom, jak [tepová frekvence ovlivňuje spalování tuků](/tepova-frekvence-spalovani/), najdete v samostatném článku.
...
Pokud ještě nezvládáte tréninky a chcete začít, [hubnutí chůzí](/hubnuti-chuzi/) je prokazatelně účinná cesta pro většinu lidí.
...
- **Týden 1:** spočítejte si TDEE v [kalkulačce BMR](/kalkulacka-bmr/), odečtěte 300–400 kcal. Začněte sledovat příjem v aplikaci (MyFitnessPal, Kalorické tabulky).
...
Pokud máte zájem o specifika podle životní fáze, podívejte se na [hubnutí po 40](/hubnuti-po-40/), [hubnutí po 50](/hubnuti-po-50/) nebo [hubnutí po porodu](/hubnuti-po-porodu/).
...
První konkrétní krok udělejte teď: spočítejte si svůj [TDEE v BMR kalkulačce](/kalkulacka-bmr/), odečtěte 400 kcal a vytvořte si jednoduchý jídelníček na zítřejší den.
