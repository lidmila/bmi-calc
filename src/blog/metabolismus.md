...
description: "Co je metabolismus a jak ovlivňuje hubnutí. Srozumitelné vysvětlení, jak funguje, co ho zpomaluje, jak ho zrychlit a kdy jde o medicínský problém."
permalink: /metabolismus/
date: 2026-04-22
dateModified: 2026-05-11
category: "Metabolismus"
perex: 'Slovo „metabolismus" slyšíte všude – v reklamách na doplňky stravy, v článcích o hubnutí, v rozhovorech s kamarádkami. Co to ale opravdu znamená a kolik z toho můžete reálně ovlivnit? Tady je srozumitelný přehled.'
heroImage: "/img/metabolismus.webp"
heroAlt: "Metabolismus: co to je a jak ovlivňuje vaši váhu"
ogImage: "/img/og-metabolismus.png"
sources:
  - { label: "NIH NIDDK – Weight management and metabolism", url: "https://www.niddk.nih.gov/health-information/weight-management" }
  ...
  - { label: "Müller MJ et al. – Functional body composition in obesity (Obes Rev 2018)", url: "https://pubmed.ncbi.nlm.nih.gov/29280300/" }
  - { label: "Spiegel K et al. – Brief communication: Sleep curtailment in healthy men is associated with decreased leptin (Ann Intern Med 2004)", url: "https://pubmed.ncbi.nlm.nih.gov/15583226/" }
  - { label: "NIH NIDDK – Hypothyroidism (underactive thyroid)", url: "https://www.niddk.nih.gov/health-information/endocrine-diseases/hypothyroidism" }
...
jsonld:
  - "@context": "https://schema.org"
    ...
    description: "Co je metabolismus a jak ovlivňuje hubnutí. Srozumitelné vysvětlení, jak funguje, co ho zpomaluje a jak ho zrychlit."
  ...
  - "@context": "https://schema.org"
    ...
    mainEntity:
      - "@type": "Question"
        name: "Co je metabolismus jednoduše?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Metabolismus je souhrn všech chemických reakcí, kterými tělo přeměňuje jídlo a kyslík na energii a stavební látky pro buňky. V běžné řeči slovem 'metabolismus' obvykle myslíme rychlost, s jakou tělo spaluje kalorie – tedy bazální metabolismus (BMR) a celkový denní výdej (TDEE)."
      - "@type": "Question"
        name: "Proč mám stejný příjem jako kamarádka, ale ona nepřibývá?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Rozdíl bývá v celkovém denním výdeji, ne v bazálním metabolismu. Faktorů hraje víc: podíl svalů, NEAT (denní pohyb mimo trénink), spánek, hormony, přesnost záznamu kalorií. Studie ukazují, že lidé v průměru podhodnocují příjem o 200–500 kcal denně, aniž si to uvědomují."
      - "@type": "Question"
        name: "Zpomaluje se metabolismus s věkem?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Méně, než si myslíme. Studie Pontzera et al. (Science 2021) ukázala, že bazální metabolismus upravený podle hmotnosti zůstává stabilní mezi 20.–60. rokem a klesá až po šedesátce o cca 0,7 % ročně. 'Pomalý metabolismus po čtyřicítce' je z 80 % důsledek ztráty svalů (sarkopenie) a nižší aktivity, ne věku samotného."
      - "@type": "Question"
        name: "Pomáhají potraviny 'spalující tuk'?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Marginálně. Zelený čaj, kofein, chilli (capsaicin) zvyšují BMR o 30–100 kcal denně po dobu několika hodin. Klinicky zanedbatelné – odpovídá to jednomu jablku navíc. Žádná dieta se na nich nedá postavit. Skutečné páky jsou silový trénink, bílkoviny, spánek a NEAT."
      - "@type": "Question"
        name: "Co dělat při podezření na pomalý metabolismus?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Začněte u praktického lékaře – TSH a fT4 (štítná žláza), glykémie, jaterní testy. Tyto základní krevní hodnoty hradí pojišťovna a vyloučí nejčastější příčiny (hypotyreóza, inzulinová rezistence). Pokud jsou v normě, problém typicky není v metabolismu, ale v přesnosti záznamu příjmu, NEAT nebo dlouhodobé adaptaci na nízký příjem."
---
...
Pokud chcete jen číselný výpočet, kolik kalorií vaše tělo spálí v klidu, podívejte se rovnou na detailní článek o [bazálním metabolismu](/bazalni-metabolismus/). Tento text je širší: vysvětlí, **co se v těle děje a proč**, a propojí to s praktickými rozhodnutími o hubnutí, jídle a pohybu.
...
Při hubnutí chcete, aby **tělo katabolizovalo tuk, ne svaly**. Klíčové páky: dostatek bílkovin, silový trénink, mírný deficit. Více v pillar článku [Jak snížit BMI](/jak-snizit-bmi/).
...
Největší kus tvoří **bazální metabolismus**. Pokud chcete porozumět jeho výpočtu a vzorci Mifflin-St Jeor, máme samostatný [článek o bazálním metabolismu](/bazalni-metabolismus/) s [BMR kalkulačkou](/kalkulacka-bmr/).

Druhá největší a často podceňovaná složka je **NEAT** – pohyb, který neevidujete jako trénink. Studie [Westerterpa (Eur J Clin Nutr 2017)](https://pubmed.ncbi.nlm.nih.gov/27966573/) ukázala, že rozdíl v NEAT mezi sedavým a aktivním člověkem může být **500–800 kcal denně** – víc než hodinový trénink.
...
- **Věk** – pomalu, ale měřitelně. [Pontzer et al. (Science 2021)](https://pubmed.ncbi.nlm.nih.gov/34385400/) ukázali, že BMR po šedesátce klesá o **0,7 % ročně**. Mezi 20.–60. rokem je překvapivě stabilní. Mýtus o „zpomalování po čtyřicítce" je z velké části chybný atribuční omyl – skutečnou příčinou je sarkopenie a nižší aktivita.
...
- **Svalová hmota** – největší modifikovatelná páka. Každý kilogram svalů spálí navíc **~13 kcal denně**. Po 50. roce klesá rychlost úbytku svalů (sarkopenie) o 1–2 % ročně, pokud aktivně neposilujete – právě proto je silový trénink ve vyšším věku tak důležitý (víc v článku [Hubnutí po 50](/hubnuti-po-50/)).
- **Fyzická aktivita** – jak cílený trénink (EAT), tak NEAT. NEAT je často podceňovaná, ale dlouhodobě jí přibyde víc.
- **Spánek** – [Spiegel et al. (Ann Intern Med 2004)](https://pubmed.ncbi.nlm.nih.gov/15583226/) ukázali, že krátkodobá spánková restrikce (4 noci po 4 hodinách) snižuje leptin o 18 % a zvyšuje ghrelin o 28 %. Praktický důsledek: nevyspalí lidé sní v průměru o 250–500 kcal denně víc.
...
- **Hypotyreóza** (snížená funkce) – BMR klesá o **10–30 %**. Příznaky: únava, mrznutí, suchá kůže, vypadávání vlasů, váhový přírůstek 2–5 kg. Diagnostika: TSH a fT4 z krve. V ČR podle ÚZIS trpí klinicky významnou hypotyreózou cca **4 % populace**, subklinickou až 10 %. [NIDDK pacientský průvodce](https://www.niddk.nih.gov/health-information/endocrine-diseases/hypothyroidism).
