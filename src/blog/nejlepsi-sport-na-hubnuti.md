...
description: "Srovnání 10 sportů na hubnutí: kolik kcal spálíte, pro koho se hodí. Plavání, běh, švihadlo, HIIT, silový trénink, pilates a 12-týdenní plán."
permalink: /nejlepsi-sport-na-hubnuti/
date: 2026-04-12
dateModified: 2026-05-11
category: "Sport"
perex: 'Chcete zhubnout a hledáte sport, který vám to usnadní? Dobrá zpráva: funguje jich víc, než si myslíte. Špatná zpráva: žádný univerzálně „nejlepší" neexistuje. Tady je srovnání podle spalování, šetrnosti ke kloubům a vhodnosti pro různé situace.'
...
sources:
  ...
  - { label: "AHA – Physical activity recommendations for adults", url: "https://www.heart.org/en/healthy-living/fitness/fitness-basics/aha-recs-for-physical-activity-in-adults" }
  - { label: "WHO – Physical activity guidelines", url: "https://www.who.int/news-room/fact-sheets/detail/physical-activity" }
  - { label: "Foster C et al. – Effectiveness of HIIT vs MICT for weight loss (PLOS ONE 2018)", url: "https://pubmed.ncbi.nlm.nih.gov/28401638/" }
  - { label: "Schoenfeld BJ et al. – Strength and hypertrophy adaptations to resistance training (J Strength Cond Res 2017)", url: "https://pubmed.ncbi.nlm.nih.gov/28834797/" }
  - { label: "Sigal RJ et al. – Effects of aerobic + resistance training on type 2 diabetes (Ann Intern Med 2007)", url: "https://pubmed.ncbi.nlm.nih.gov/17909201/" }
  - { label: "Tudor-Locke C, Bassett DR. – How many steps/day are enough? (Sports Med 2004)", url: "https://pubmed.ncbi.nlm.nih.gov/14715035/" }
  - { label: "Westerterp KR – Control of energy expenditure in humans (Eur J Clin Nutr 2017)", url: "https://pubmed.ncbi.nlm.nih.gov/27966573/" }
jsonld:
  - "@context": "https://schema.org"
    "@type": "Article"
    headline: "Nejlepší sporty na hubnutí: který si vybrat?"
    description: "Srovnání 10 sportů na hubnutí: kolik kcal spálíte, pro koho se hodí, jak vybrat podle BMI a věku."
  ...
  - "@context": "https://schema.org"
    ...
    mainEntity:
      - "@type": "Question"
        name: "Jaký sport spaluje nejvíc kalorií?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Z běžně dostupných aktivit nejvíc kalorií spálí švihadlo (600–900 kcal/h) a HIIT (500–800 kcal/h). Při běhu (8 km/h) spálíte 500–700 kcal/h. Ale 'nejlepší' sport není ten s největším spalováním, ale ten, který vydržíte dělat měsíce a roky. Plavání nebo svižná chůze pravidelně 4× týdně přinese víc než švihadlo, které vzdáte po 14 dnech."
      - "@type": "Question"
        name: "Co je lepší pro hubnutí: kardio, nebo silový trénink?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Pro samotný úbytek hmotnosti zvládne kalorický deficit kardio i silový. Ale pro kvalitu úbytku (víc tuku, méně svalů) je silový trénink nepostradatelný. Optimální kombinace: 2× silový trénink + 2–3× kardio týdně + denní chůze. Bez silového při deficitu ztratíte 25–30 % hmotnosti ze svalů, ne z tuku."
      - "@type": "Question"
        name: "Funguje HIIT lépe než klasické kardio?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Pro úbytek tuku jsou srovnatelné. Meta-analýza Foster et al. (PLOS ONE 2018) ukázala, že HIIT a klasické kardio střední intenzity (MICT) vedou ke srovnatelnému úbytku hmotnosti při stejném celkovém kalorickém výdeji. HIIT má výhodu v časové úspoře (20 min HIIT ≈ 45 min běhu), ale je tvrdší pro klouby a srdce. Pro začátečníky a po 40. roce preferujeme zónu 2."
      - "@type": "Question"
        name: "Stačí mi chodit, nebo musím opravdu sportovat?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Pro většinu lidí stačí svižná chůze + úprava stravy. WHO doporučuje 150 minut středně intenzivní aktivity týdně – splníte to 30 minutami chůze 5 dnů v týdnu. Ale pokud chcete chránit svaly (zvlášť po 40. roce), je třeba přidat silový trénink 2× týdně. Cvičit doma s vlastní vahou nebo gumami je dostatečné."
      - "@type": "Question"
        name: "Můžu sportovat, když mám BMI nad 30?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Ano, ale s rozumem. Vyhněte se vysokonárazovým aktivitám (běh, skoky, švihadlo), které zatěžují kolena. Volte plavání, kolo, eliptický trenažer, chůzi nebo silový trénink na strojích. Při BMI nad 35 doporučujeme před začátkem konzultaci s praktickým lékařem nebo obezitologem."
---
...
**Důležitá poznámka:** při vyšší hmotnosti spalujete víc, protože pohyb stojí víc energie. Osoba 100 kg spálí při stejné aktivitě o 25–30 % víc než osoba 75 kg. Pokud chcete přesnější odhad, použijte naši [BMR / TDEE kalkulačku](/kalkulacka-bmr/).

## Plavání: nejkomplexnější celotělový trénink

Plavání zapojuje **všechny hlavní svalové skupiny** současně, je úplně šetrné ke kloubům (voda nese 90 % vaší hmotnosti) a díky odporu vody je trénink intenzivní i při nižší rychlosti. Pro lidi s [BMI nad 30](/stupne-obezity/), problémy s klouby nebo starší dospělé je často první volba.
...
**Klíčová rada:** tempo má být tak nízké, abyste mohli mluvit v celých větách (zóna 2, 60–70 % maximálního tepu). Spočítejte si v [kalkulačce tepových zón](/kalkulacka-tep/). 80 % začátečníků běhá příliš rychle a vzdá to do 3 měsíců.
...
**Pozor:** švihadlo není vhodné při BMI nad 30, problémech s koleny nebo s pánevním dnem. Nárazy jsou velké. V takovém případě začněte s [chůzí](/hubnuti-chuzi/) nebo plaváním a vraťte se ke švihadlu po prvních 10 kg úbytku.
...
[Meta-analýza Fostera et al. (PLOS ONE 2018)](https://pubmed.ncbi.nlm.nih.gov/28401638/) porovnala HIIT s klasickým kardiem střední intenzity (MICT) u 38 studií a ukázala, že **úbytek hmotnosti je při stejném kalorickém výdeji srovnatelný**.
...
Detailněji o tepových zónách najdete v článku o [tepové frekvenci pro spalování tuků](/tepova-frekvence-spalovani/).
...
- **Posiluje kosti** – prevence osteoporózy, zvlášť důležité u žen v menopauze ([Schoenfeld 2017](https://pubmed.ncbi.nlm.nih.gov/28834797/)).
- **Zlepšuje držení těla a glykémii** – kombinovaný silový + aerobní trénink je nejúčinnější u diabetiků 2. typu ([Sigal et al., Ann Intern Med 2007](https://pubmed.ncbi.nlm.nih.gov/17909201/)).
...
Pokud máte přes 50, podívejte se na [hubnutí po 50](/hubnuti-po-50/) s adaptovaným silovým programem zaměřeným na sarkopenii.
...
- **Po porodu** – posiluje pánevní dno a diastázu (viz [hubnutí po porodu](/hubnuti-po-porodu/)).
...
Nejvíc podceňovaná. Svižná chůze 6 km/h spálí 300–450 kcal/h. Velký rozdíl dělá **NEAT** – pohyb mimo trénink. [Tudor-Locke (Sports Med 2004)](https://pubmed.ncbi.nlm.nih.gov/14715035/) ukázal, že lidé s 10 000+ kroky denně vážili v průměru o 6 kg méně než ti se 4 000. Více v článku [hubnutí chůzí](/hubnuti-chuzi/).
...
Sport je důležitý doplněk, ne náhrada za stravu. **Hubnutí je z 80 % o jídelníčku** – sport pomáhá udržet svaly a zdraví, ale samotný kalorický deficit přichází z [počítání kalorií](/pocitani-kalorii/). Pro detailní plán snižování BMI viz pillar [jak snížit BMI](/jak-snizit-bmi/).
